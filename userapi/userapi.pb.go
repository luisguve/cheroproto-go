...
func (m *RecentActivityRequest) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
type SavedThreadsResponse struct {
	References           []*context.Thread `protobuf:"bytes,1,rep,name=references,proto3" json:"references,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SavedThreadsResponse) GetReferences() []*context.Thread {
	if m != nil {
		return m.References
	}
	return nil
...
var fileDescriptor_e9b6856a7d7dae4b = []byte{
	...
	,
}
...
type CrudUsersClient interface {
	...
	// there.
	SaveNotif(ctx context1.Context, in *NotifyUser, opts ...grpc.CallOption) (*SaveNotifResponse, error)
	...
	RecentActivity(ctx context1.Context, in *RecentActivityRequest, opts ...grpc.CallOption) (*dataformat.Activity, error)
...
func (c *crudUsersClient) SaveNotif(ctx context1.Context, in *NotifyUser, opts ...grpc.CallOption) (*SaveNotifResponse, error) {
...
func (c *crudUsersClient) RecentActivity(ctx context1.Context, in *RecentActivityRequest, opts ...grpc.CallOption) (*dataformat.Activity, error) {
	out := new(dataformat.Activity)
...
type CrudUsersServer interface {
	...
	// If the notification was in the list of read notifications, it removes it from
	// there.
	SaveNotif(context1.Context, *NotifyUser) (*SaveNotifResponse, error)
	// Append thread to list of recent activity of user.
	...
	// Get the recent activity of a user.
	RecentActivity(context1.Context, *RecentActivityRequest) (*dataformat.Activity, error)
	// Get saved threads of a user.
...
func (*UnimplementedCrudUsersServer) SaveNotif(ctx context1.Context, req *NotifyUser) (*SaveNotifResponse, error) {
...
func (*UnimplementedCrudUsersServer) RecentActivity(ctx context1.Context, req *RecentActivityRequest) (*dataformat.Activity, error) {
...
func _CrudUsers_SaveNotif_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
		return srv.(CrudUsersServer).SaveNotif(ctx, req.(*NotifyUser))
	}
	return interceptor(ctx, in, info, handler)
}
